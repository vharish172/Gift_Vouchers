...
public class stepdefinition {
	...
	public void choose_the_status() throws InterruptedException {
	...
	public void edit_the_gift_card_code_which_has_consist_of_digits_numeric_and_alphapets(Integer int1, Integer int2) throws InterruptedException {
	...
	public void add_the_voucher_theme_name() throws InterruptedException {
	...
	public void edit_the_voucher_theme_name() throws InterruptedException {
	...
	public void user_will_navigate_to_the_voucher_theme_for_edit_the_theme() {
		
		System.setProperty("webdriver.chrome.driver", ".//lib//chromedriver.exe");
		driver=new ChromeDriver();
		System.out.println("webdriver is initialized");
		driver.get("http://retailm1.upskills.in/admin/index.php?route=sale/voucher_theme&token=p53Y6RQXv4eiXYHTH2dtVHNqUmriWu9N");
		driver.findElement(By.name("username")).sendKeys("admin");
		driver.findElement(By.name("password")).sendKeys("Admin@123"); 
		driver.findElement(By.tagName("button")).click();
	...
	public void we_select_the_any_of_the_gift_voucher() {
		driver.findElement(By.xpath("//input[@value='87']")).click();
		
	    
	}

	@When("the clicking the edit icon")
	public void the_clicking_the_edit_icon() throws InterruptedException {
	...
	public void it_should_take_us_through_the_edit_gift_voucher_page() throws InterruptedException {
